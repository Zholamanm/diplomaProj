<template>
  <div class="dashboard-container">
    ...
    <div>
      <img src="https://bookers.com.kz/public/storage/home/1747902338448.jpg" alt="" style="position: absolute; z-index: 0; width: 100%; height: 750px; left: 0">
      <section class="hero-section">
        ...
        <div class="book-stack-animation">
          <div class="book" v-for="(book, index) in featuredBooks" :key="book.id"
            ...
            <div class="book-cover" :style="{ backgroundImage: book.cover_image ? `url(https://bookers.com.kz/public/storage/${book.cover_image})` : 'url(https://bookers.com.kz/defaults/default-cover.jpg)' }"></div>
          </div>
        </div>
      </section>
    </div>
    ...
    <section class="personalized-section">
      ...
      <div class="recommendation-cards">
        <div class="rec-card" v-for="rec in personalizedRecs" :key="rec.id"
          ...
          <div class="rec-cover"
               :style="{ backgroundImage: rec.cover_image ? `url(https://bookers.com.kz/public/storage/${rec.cover_image})` : 'url(https://bookers.com.kz/defaults/default-cover.jpg)' }"></div>
