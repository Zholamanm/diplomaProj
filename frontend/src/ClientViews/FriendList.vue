      ...
      <div v-if="friends.length > 0" class="friends-grid">
        ...
        >
          <div class="friend-avatar-container">
            <img
                :src="friend.profile_picture ? `https://bookers.com.kz/public/storage/${friend.profile_picture}` : 'https://bookers.com.kz/defaults/default-profile.jpg'"
                class="friend-avatar"
      ...
      <div v-if="pendingRequests.length > 0" class="requests-list">
        ...
        >
          <div class="request-avatar-container">
            <img
                :src="request.profile_picture ? `https://bookers.com.kz/public/storage/${request.profile_picture}` : 'https://bookers.com.kz/defaults/default-profile.jpg'"
